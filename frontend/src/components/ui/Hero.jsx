...
export function Hero({ movie }) {
    ...
    const description = movie?.overview || "Paul Atreides unites with Chani and the Fremen while on a warpath of revenge against the conspirators who destroyed his family. Facing a choice between the love of his life and the fate of the known universe, he endeavors to prevent a terrible future only he can foresee.";
    ...
    return (
        <section className="relative mb-12 rounded-xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute inset-0 z-20 flex flex-col justify-center px-8 md:px-16 max-w-2xl">
                <span className="text-yellow-500 font-bold tracking-wider mb-2">FEATURED PREMIERE</span>
